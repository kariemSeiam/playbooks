...
source: 'research — Google & Ipsos, "Decoding Decisions: The Messy Middle of Purchase Behavior" (2020); general CX/journey-mapping practice literature'
tags: [customer-experience, touchpoints, mapping, cx, journey]
---
...
- Explaining why a linear funnel model understates how customers actually shop today
- Diagnosing where trust is won or lost in a long consideration cycle (B2B, high-ticket, healthcare)
...
Customers bounce between Exploring and Evaluating an unpredictable number of times before exiting to purchase — a customer might explore, narrow to two options, re-open exploration after seeing a competitor's ad, then re-narrow, repeatedly, often across days and multiple devices. The old funnel's clean, one-directional narrowing doesn't match this observed behavior.

**Six cognitive biases the study found systematically influence the messy middle** — worth naming to a client building content or conversion strategy for this stage:

| Bias | Effect |
|---|---|
| Category heuristics | Simple rules of thumb ("best-selling," "most reviewed") used to judge options quickly without deep evaluation |
| Power of now | Immediate availability outweighs a marginally better but slower option |
| Social proof | Reviews and ratings from others reduce perceived risk |
| Scarcity bias | Limited availability or time-limited offers increase perceived value and urgency |
| Authority bias | Recommendations from experts or trusted figures carry outsized weight |
...
4. Overlay an emotional curve across the whole map — usually the single most useful visual in a client workshop, because it makes the worst moment of the experience impossible to argue away.
5. Mark moments of truth — the few touchpoints disproportionately likely to make or break the relationship, often a first support interaction or an onboarding/delivery moment, not the touchpoints marketing spends the most time perfecting.

## Example

A mid-market B2B SaaS client's journey map for its target persona (an operations manager): **Awareness** — a LinkedIn post and a peer recommendation both surface the brand, two separate Exploring-mode entries rather than one "awareness" event. **Messy Middle** — the buyer explores four competitor sites and two review platforms over three weeks, narrows to a shortlist of two on price and integration fit, then re-opens exploration after a competitor's retargeting ad surfaces a case study they hadn't seen, before re-narrowing. **Purchase** — a demo call with sales, where the emotional curve dips sharply because the rep couldn't answer an integration question live, a moment of truth owned by Sales and invisible to Marketing's dashboards. **Retention** — a slow onboarding handoff to Customer Success produces a second dip. **Advocacy** — despite the rocky onboarding, the customer later leaves a positive review because the core product solved their problem, illustrating that the map's worst moment and the eventual outcome aren't always the same thing — the map still flags the onboarding dip as the top-priority fix, since it's actively costing referral and expansion revenue.
...
- [value-proposition-canvas.md](../marketing/value-proposition-canvas.md) — the Pains and Gains captured there are what populate a journey map's friction points and emotional curve
