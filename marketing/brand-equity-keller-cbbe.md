---
domain: marketing
concept: Customer-Based Brand Equity (CBBE) / Brand Resonance Pyramid
source: research — Kevin Lane Keller, "Strategic Brand Management" (1998) and "Building Customer-Based Brand Equity" (Marketing Science Institute, 2001)
tags: [brand, equity, resonance, positioning, awareness]
---

# Customer-Based Brand Equity (CBBE) / Brand Resonance Pyramid
...
- Auditing a brand extension or new-market entry — checking which Meaning actually transfers into the new category or market
- Explaining to a client why an awareness campaign alone won't produce loyalty or a price premium

## How it works

Four ascending stages, six building blocks, culminating in Resonance at the apex.
...
**4. Resonance (apex) — What about you and me?** The nature and strength of the psychological bond. Four sub-dimensions: Behavioral Loyalty (repeat purchase, share of category spend), Attitudinal Attachment (loving the brand, treating it as special), Sense of Community (kinship with other users of the brand), Active Engagement (seeking out brand content, joining programs, engaging beyond the transaction itself).

**The sequential logic.** Blocks build strictly bottom-up: Salience → Meaning (Performance + Imagery) → Response (Judgments + Feelings) → Resonance. A brand cannot have real Resonance without positive Judgments and Feelings already in place, which requires Meaning to already exist, which requires Salience first. Investment at the top of the pyramid without the base in place is wasted — a loyalty program bolted onto a brand nobody recalls at the point of purchase does not work.

**Duality within each stage.** Both Performance and Imagery must be built (rational and emotional); both Judgments and Feelings must be built (head and heart). This is why "just be functionally superior" doesn't build strong equity on its own — competitors can copy functional performance far more easily than they can copy imagery and feeling.

## Example

Apple, worked through the pyramid: **Salience** — near-universal recall across many purchase situations (phone, laptop, watch, and more). **Performance** — reliability, build quality, ecosystem interoperability. **Imagery** — a creative-professional, aspirational user profile; a minimalist design heritage dating to 1984. **Judgments** — high perceived quality, credibility from consistent execution, considered "for me" by a loyal segment, judged superior in design and UX by that same segment. **Feelings** — excitement at product launches, self-respect and social approval from owning the "premium" brand, security from a consistent privacy and reliability story. **Resonance** — extremely high: customers queue overnight for launches (Active Engagement), see themselves as "Apple people" (Sense of Community), and buy the next iPhone without shopping around (Behavioral Loyalty). Every block visibly reinforces the one above it.
...
- [building-customer-relationships.md](../marketing/building-customer-relationships.md) — the Behavioral Loyalty sub-dimension of Resonance overlaps with the retention economics there
